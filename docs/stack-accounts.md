...
These accounts are required for oracle image installation and configuration

## oracle

* oracle administrator username: `admin`
* oracle administrator password: stored in the file of your server */credentials/password.txt*
